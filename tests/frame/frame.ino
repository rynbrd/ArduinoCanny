...
test(VariantTest, RoundTrip) {
    CAN20Frame f(0x123, 0, {0x1A, 0x2B, 0x4C, 0x5D});
    FrameVariant v(f);
...
test(DataTest, LessSize) {
    CAN20Frame f(0x123, 0, {0x1A, 0x2B, 0x4C, 0x5D, 0x6E, 0x7F, 0x80, 0x91});
...
test(SetTest, SmallerFrame) {
    CANFDFrame f1(0x123, 0, {0x1A, 0x2B, 0x4C, 0x5D, 0x6E, 0x7F, 0x80, 0x91, 0x52, 0xBC});
    CAN20Frame f2(0x321, 1, {0xF1, 0xE2});
...
test(SetTest, LargerFrame) {
    CAN20Frame f1(0x321, 1, {0xF1, 0xE2});
    CANFDFrame f2(0x123, 0, {0x1A, 0x2B, 0x4C, 0x5D, 0x6E, 0x7F, 0x80, 0x91, 0x52, 0xBC});
